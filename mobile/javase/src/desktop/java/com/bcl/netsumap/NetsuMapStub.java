 ...
 * @author Shai Almog
 */
public class NetsuMapStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "NetsuMap";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new NetsuMapStub());
    }
